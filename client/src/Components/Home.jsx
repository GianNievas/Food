...
import { getAllFoods, getDiets, getAllFoodsy } from "../State/actions";
...
export default function Home() {
  ...
  function handleHealth70(e) {
    setHealth(e.target.value);
    dispatch(getAllFoodsy());
    setCurrentPage(1);
  }
    ...
    <div className="home">
      ...
      <div>
        ...
        <div>
          ...
          <p>
          <select className="options" onChange={(e) => handleHealth70(e)}>
          <button className="btnHome">healt score max' </button>
          </select>
